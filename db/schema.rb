...
ActiveRecord::Schema[7.0].define(version: 2023_11_21_091610) do
  ...
  create_table "user_infos", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["accounts_id"], name: "index_user_infos_on_accounts_id"
  ...
  add_foreign_key "user_infos", "accounts", column: "accounts_id"
end
